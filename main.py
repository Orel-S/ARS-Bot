...
POST_LIMIT = 2
COMMENT_LIMIT = 5
DIRECTORY = "C:\\Users\\orel0\\PycharmProjects\\askredditbot\\Recordings\\"
FILE_EXTENSION = '.mp3'
TIME = 'day'
...
for item in sub_array:
    ...
    g.save(DIRECTORY + shortened_title + '\\' + shortened_title + FILE_EXTENSION)
    k = 1
    for comment in item[1]:
        ...
        if shortened_comment != '':
            g.save(DIRECTORY + shortened_title + '\\' + shortened_comment + FILE_EXTENSION)
        k += 1
